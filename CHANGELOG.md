...
- **Two of Shalom's calls, applied.** Ch 38's ladder now follows 韓非 (*Hán Fēi*)'s cascade, *"When the Tao is lost, then integrity is lost,"* departing from the base, because his own essay argues each rung is made from the one above. Ch 14's 古始 (*gǔ shǐ*) is *the ancient beginning*, no longer *the primordial source*.
